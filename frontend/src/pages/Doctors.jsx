...
const Doctors = () => {
  ...
  className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-20 border border-gray-300 rounded transition-all cursor-pointer ${speciality === 'General physician' ? 'bg-[#E2E5FF] text-black ' : ''}`}>
  General physician
</p>
